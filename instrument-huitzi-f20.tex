...
\begin{figure*}
\begin{center}
\includegraphics[width=0.9\linewidth]{figures/huitzi-on-telescope.jpg}
\medskip
...
\begin{figure*}
\begin{center}
\includegraphics[angle=90,width=0.9\linewidth]{figures/huitzi-lens-design.pdf}
\medskip
...
\end{center}
\caption{Drawing of part 6: the FLI CFW-1-5 filter wheel. The CFW-1-8 wheel differs only internally.}
...
\begin{figure*}
\begin{center}
\includegraphics[angle=00,width=0.7\linewidth]{figures/huitzi-f20-fli-adapter.jpg}
\end{center}
...
One detail that is not shown in the drawings are the internal baffles. On the lower sides of filter wheels A and B we have installed FLI-supplied adapters as shown in Figure~. Within these we have placed two black nylon baffles, shown in Figure~\ref{figure:huitzi-f20-part-Z}, to reduce scattered light.
