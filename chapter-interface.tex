...
The web site contains the interface and documentation. The interface is only directly available to computers on the mountain-top network, although ssh port-forwarding and VPNs can make it indirectly available elsewhere. The documentation is available directly to computers on the mountain-top network and the Instituto de Astronomía networks in Ensenada and CU.
...
The interface and documentation can be accessed locally by OAN technical staff using the Mac in the shed.
